...
class ImageNet(data.Dataset):
    ...
    def preprocess(self):
        ...
        print('[INFO] Finished preprocessing the ImageNet dataset.')
...
def get_loader(image_dir, attr_path, selected_attrs, crop_size=178, image_size=128,
                batch_size=8, dataset='CelebA', mode='train', num_workers=0):    
    transform = []
    if mode == 'train':
...
def get_loader_class(image_dir, attr_path, selected_attrs, crop_size=178, image_size=128,
                     batch_size=8, dataset='ImageNet', mode='train', num_workers=0):
